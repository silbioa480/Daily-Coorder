...
//     const [adimageNumber,setAdImageNumber]=useState<IAdImage["ad_image_id"]>();
...
//                         <div className="AdImg">
//                             <Image  thumbnail style={{height: "100%"}} alt="Ad image"/>
//                             <label className="btn btn-white bg-white" htmlFor="ad_image_id"
//                                    style={{color: "black", fontWeight: "bold", fontSize: "1vw", borderRadius: "20px"}}>
//                                 광고 이미지 선택<Form.Control type="file" style={{display: "none"}}
