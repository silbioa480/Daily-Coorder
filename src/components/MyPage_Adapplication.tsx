            ...
            <AdApplicationCss />
                <div className="AdContainer">
                        ...
                        <div className="TitleSpace">
                            <Form.Label style={{textAlign:"center",marginTop:"1vw",fontWeight:"bold",fontSize:"1.5vw"}}>광고 제목</Form.Label>
                        ...
                        <div style={{display:"flex"}}>
                                <div className="AdImg">
                                    ...
                                    <label className="btn btn-white bg-white" htmlFor="adimage" style={{color:"black",fontWeight:"bold",fontSize:"1vw",borderRadius:"20px"}}>
                                            광고 이미지 선택<Form.Control type="file" style={{display:"none"}} onChange={onloadfile} id="adimage" accept="image/*"/>
                                    </label>
                                </div>
                                <div style={{marginLeft:"1vw",display:"flex",flexDirection:"column",justifyContent:"space-between"}}>
                                        <div className="Adurl">
                                            ...
                                            <Form.Control type="url" placeholder="URL 입력" style={{width:"300px",marginTop:"1vw"}}/>
                                        </div>
                                        <div className="TagSpace" style={{marginBottom:"2vw"}}>
                                                ...
                                                <Form.Control type="text" placeholder="태그 입력" value={hashtag} onChange={onChangeHashtag} onKeyUp={onKeyUp}/>
                                        </div>
                                </div>
                        </div>

                        <div className="Addescription">
                                        <Form.Label style={{textAlign:"center",fontWeight:"bold",fontSize:"1.5vw"}}>광고 내용 설명</Form.Label>
                                        <FormControl as="textarea" aria-label="내용 설명" placeholder="내용을 입력하세요" style={{marginTop:"1vw"}}/>
                        </div>
